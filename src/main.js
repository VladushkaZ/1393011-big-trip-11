...
render (siteHeaderElement, createDistTemplate());


const siteBtnElement = siteMainElement.querySelector(`.trip-main__trip-info`);
const siteCostElement = siteBtnElement.querySelector(`.trip-info__cost`);
...
//const sitePointElement = siteEventElement.querySelector(`.trip-days`);
//const siteListElement = sitePointElement.querySelector(`.trip-events__list`);
